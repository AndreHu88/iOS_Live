...
- (void)addLineforPlainCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath withLeftSpaceAndSectionLine:(CGFloat)leftSpace{
    ...
    CGColorRef lineColor = UIColorHex(dddddd).CGColor;
...
- (void)addLineforPlainCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath withLeftSpace:(CGFloat)leftSpace hasSectionLine:(BOOL)hasSectionLine{
    ...
    CGColorRef lineColor = UIColorHex(D8DDE4).CGColor;
...
- (UITapImageView *)getHeaderViewWithStr:(NSString *)headerStr andBlock:(void(^)(id obj))tapAction{
    return [self getHeaderViewWithStr:headerStr color:UIColorHex(F2F4F6) andBlock:tapAction];
}

- (UITapImageView *)getHeaderViewWithStr:(NSString *)headerStr color:(UIColor *)color andBlock:(void(^)(id obj))tapAction{
    UITapImageView *headerView = [[UITapImageView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth,30)];
    [headerView setImage:[UIImage imageWithColor:color]];
    
    UILabel *headerLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, kScreenWidth-20, CGRectGetHeight(headerView.frame))];
    headerLabel.backgroundColor = [UIColor clearColor];
    headerLabel.textColor = UIColorHex(999999);
    headerLabel.font = KFitFont(12);
...
- (UITapImageView *)getHeaderViewWithStr:(NSString *)headerStr color:(UIColor *)color leftNoticeColor:(UIColor*)noticeColor andBlock:(void(^)(id obj))tapAction{
    UITapImageView *headerView = [[UITapImageView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth,44)];
    [headerView setImage:[UIImage imageWithColor:color]];
    ...
    UILabel *headerLabel = [[UILabel alloc] initWithFrame:CGRectMake(12+3+10, 7, kScreenWidth-20, 30)];
    headerLabel.backgroundColor = [UIColor clearColor];
    headerLabel.textColor = UIColorHex(999999);
    headerLabel.font = KFitFont(12);
    ...
    CGFloat lineHeight = (1.0f / [UIScreen mainScreen].scale);
    UIView *seperatorline = [[UIView alloc] initWithFrame:CGRectMake(0, 44-lineHeight,kScreenWidth , lineHeight)];
    seperatorline.backgroundColor = UIColorHex(dddddd);
